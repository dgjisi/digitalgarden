...
![image.png](https://tc.899900.xyz/img/202407081600751.png)

## 正式开始步骤

#### 一、在D盘新建一个excel文件，用于保存数据
![image.png](https://tc.899900.xyz/img/202407091354221.png)

#### 二、输入对应的数据
![image.png](https://tc.899900.xyz/img/202407091357297.png)

#### 三、打开CCD程序，并打开左上角文件，选择==数据校正==
![image.png](https://tc.899900.xyz/img/202407091400171.png)

#### 四、在弹出窗口同样点左上角文件，==读EXCEL==
![image.png](https://tc.899900.xyz/img/202407091402681.png)
...
##### 如图示例
![image.png](https://tc.899900.xyz/img/202407091418278.png)
